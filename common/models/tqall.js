...
module.exports = function (tqall) {
  ...
  tqall.search = function (searchtext, page, limit, cb) {
    ...
    //
    var total_sql = "Select count(*) totalviewall from tqall where lower(accnumber||client_name||arocode||custnumber||branchname||colofficer||section) like '%" + searchtext.toLowerCase() + "%'";
